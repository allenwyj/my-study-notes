...
Student [id=50, firstName=Paul, lastName=Doe, email=paul@luv2code.com, dateOfBirth=null]Student [id=51, firstName=Daffy, lastName=Duck, email=daffy@luv2code.com, dateOfBirth=null]Student [id=52, firstName=Paul, lastName=Doe, email=paul@luv.com, dateOfBirth=31/12/1998]

**Development Process Overview**

1. Alter database table for student2. Add a date utils class for parsing and formatting dates3. Add date field to Student class4. Add toString method to Student class5. Update CreateStudentDemo
...
- dd: day in month (number)- MM: month in year (number)- yyyy: year
...
return "Student [id=" + id + ", firstName=" 
				...
				+ email + ", dateOfBirth=" + DateUtils.formatDate(dateOfBirth) + "]";
```
